 ...
 * @author samuel
 */
public class POSTESTADOS extends javax.swing.JFrame {
    ...
    private void RegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegistrarActionPerformed
         //Insercion
        conector();
        String sql = "INSERT INTO estados (idEstado, nombre) VALUES (?, ?)";
        try (PreparedStatement preparedStatement = con.prepareStatement(sql)) {
            ...
            if (filasInsertadas > 0) {
                ...
                JOptionPane.showMessageDialog(rootPane, "Estado agregada");
            } else {
                System.out.println("No se pudo insertar el registro");
            }
        } catch (SQLException ex) {
            Logger.getLogger(POSTESTADOS.class.getName()).log(Level.SEVERE, null, ex);
        } 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(POSTESTADOS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new POSTESTADOS().setVisible(true);
            }
        });
    }
